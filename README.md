...
Агент для сбора информации об ОС Windows, построенный на принципах микросервисной архитектуры. Система состоит из отдельных сервисов, взаимодействующих через очереди задач и результатов.
## Требования
